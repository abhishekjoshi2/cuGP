...
int main(int argc, char *argv[])
{
	...
	int numtrain = 10000;
	std::string prefix_input_file_name = "../chunked_dataset/sine_dataset_10000_10_chunk";
	std::string prefix_label_file_name = "../chunked_dataset/sine_dataset_10000_10_label"; 
